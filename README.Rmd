...
The goal of _airt_ is to evaluate a portfolio of algorithms using Item Response Theory (IRT). To fit the IRT models, I have used the R packages _mirt_ and _EstCRM_.  
...
The *stability/consistency* feature tells us how consistent an algorithm is.
